...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { avail_seats: @seat.avail_seats, bus_id: @seat.bus_id, route_id: @seat.route_id, s_dtime: @seat.s_dtime, unavail_seats: @seat.unavail_seats } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { avail_seats: @seat.avail_seats, bus_id: @seat.bus_id, route_id: @seat.route_id, s_dtime: @seat.s_dtime, unavail_seats: @seat.unavail_seats } }
